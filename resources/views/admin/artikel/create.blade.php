    ...
    <div class="">
      <div class="page-title">
        <div class="title_left">
          ...
          <div style="width: 101px; height: 3px; border-radius: 10px; background-color: #2A3F54;"></div>
        </div>
        ...
        <div class="col-md-12 ">
          ...
          <div class="x_panel">
            ...
            <div class="x_content">
              ...
              <form method="post" action="{{ url("dashboard/artikel/$kategoriArtikel/store") }}" id="demo-form"
                enctype="multipart/form-data" data-parsley-validate>
                @csrf
                <label for="fullname">Judul * :</label>
                <input value="{{ old('judul') }}" type="text" id="fullname" class="form-control" name="judul" />
                @error('judul')
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    ...
                    <input value="{{ old('tanggal') }}" type="date" id="fullname" class="form-control"
                      name="tanggal" />
                    @error('tanggal')
                      <div class="text-danger mt-1">{{ $message }}</div>
                    @enderror
