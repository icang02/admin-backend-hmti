                      ...
                      <tbody>
                        @foreach ($kategoriArtikel as $kategori)
                          <tr>
                            ...
                            <td>
                              <button data-toggle="modal" data-target="#mEdit{{ $kategori->id }}"
                                class="btn btn-sm btn-secondary"><i class="fa fa-edit"></i></button>
                              <form class="d-inline" action="{{ route('destroy-kategori_artikel', $kategori->id) }}"
                                method="post">
                                @csrf
                                @method('delete')
                                <button onclick="return confirm('Hapus kategori?')" type="submit"
                          ...
                          {{-- Modal Edit --}}
                          <div class="modal fade" id="mEdit{{ $kategori->id }}" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                              <div class="modal-content">
                                ...
                                <form action="{{ route('update-kategori_artikel', $kategori->id) }}" method="post"
                                  ...
                                  <div class="modal-body">
                                    <div class="form-group">
                                      <label for="nama">Nama Kategori</label>
                                      <input value="{{ old('nama', $kategori->nama) }}" name="nama" type="text"
