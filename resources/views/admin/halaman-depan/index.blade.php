                                        ...
                                        <table class="table table-striped table-bordered table-sm" style="width:100%">
                                            ...
                                            <tbody>
                                                @foreach ($data as $item)
                                                    <tr>
                                                        ...
                                                        <td class="text-nowrap text-center">
                                                            ...
                                                            @if (
                                                                ...
                                                                <form
                                                                    action="{{ route('destroy-halaman-depan', $item->id) }}"
                                                        ...
                                                        <td>
                                                            @if ($item->kategori == 'slider' || $item->kategori == 'foto kahim' || $item->kategori == 'foto wakahim')
                                                                ...
                                                                <a href="{{ request()->root() . "/storage/$item->content" }}"
                                                                    target="_blank">
                                                                    <img src="{{ asset("storage/$item->content") }}"
                                                                        width="{{ $item->kategori == 'slider' ? '250' : '150' }}"
                                                                        class="img-thumbnail">
                                                                </a>
                                                            @else
                                                                {{ $item->content }}
                                                    ...
                                                    <!-- Modal -->
                                                    <div class="modal fade" id="mEdit{{ $item->id }}" tabindex="-1"
                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered modal-lg"
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <form
                                                                    action="{{ route('update-halaman-depan', $item->id) }}"
